    ...
    const result = await streamObject({
        ...
        schema: z.object({
            labels: z.array(z.object({
                ...
                prop1: z.string().describe("Propiedad izquierda (ej: REVITALIZA)"),
                prop2: z.string().describe("Propiedad derecha (ej: ANTIOXIDANTE)"),
        ...
        system: "Eres un asistente experto en cosmética natural. Tu trabajo es analizar el pedido del usuario y generar una lista de etiquetas para productos. \n" +
            ...
            "2. Extrae o infiere 2 propiedades cortas (máximo 1 o 2 palabras) para 'prop1' y 'prop2'.\n" +
